    ...
    >
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
                Founded in 2019, our real estate company was born from a vision
                to transform the way people find and purchase their dream homes.
                We believe that luxury real estate should be accessible,
                transparent, and tailored to each client's unique needs.
              </p>
              <p className="text-zinc-700 dark:text-zinc-300">
                What started as a small team of passionate real estate
                enthusiasts has grown into a network of dedicated professionals,
                committed to excellence in every property we represent.
              </p>
            </div>
            <div>
              <motion.img
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-100 dark:bg-zinc-900 p-6 rounded-2xl">
              ...
              <p className="text-zinc-700 dark:text-zinc-400">
                ...
                from property curation to client relationships.
              </p>
            </div>
            <div className="bg-zinc-100 dark:bg-zinc-900 p-6 rounded-2xl">
              <h3 className="text-xl font-medium mb-3">Integrity</h3>
              <p className="text-zinc-700 dark:text-zinc-400">
                We operate with unwavering integrity, ensuring transparency and
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 p-6 rounded-2xl">
              ...
              <p className="text-zinc-700 dark:text-zinc-400">
                We embrace innovation, constantly seeking new ways to enhance
                the real estate experience for our clients.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* <div className="content-section">
          <h2 className="text-3xl md:text-4xl font-light mb-6">Our Team</h2>
